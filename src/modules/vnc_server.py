...
# Default Xvfb resolution for virtual display
# Browser-use will manage its own viewport independently
DEFAULT_XVFB_RESOLUTION = "1920x1200x24"
...
class VNCServer:
    ...
    async def start(self):
        ...
        try:
            ...
            # Start virtual display (Xvfb) with default resolution
            xvfb_resolution = DEFAULT_XVFB_RESOLUTION
            current_app.logger.info(
